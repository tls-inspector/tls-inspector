...
- (NSString *) PlatformString{
    ...
    if ([platform isEqualToString:@"iPad4,6"])      return @"iPad mini 2G (Cellular - China)";
    ...
    if ([platform isEqualToString:@"iPad4,9"])      return @"iPad mini 3G (Cellular - China)";
    if ([platform isEqualToString:@"iPad5,1"])      return @"iPad mini 4G (WiFi)";
    if ([platform isEqualToString:@"iPad5,2"])      return @"iPad mini 4G (Cellular)";
