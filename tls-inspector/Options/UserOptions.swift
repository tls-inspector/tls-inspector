...
public final class UserOptions {
    ...
    static var firstRunCompleted: Bool {
        ...
        set {
            ...
            LogWriter.shared.write(.Debug, message: "[\(#fileID):\(#line)] Setting AppDefault: \(KEY_FIRST_RUN_COMPLETE) = \(newValue)")
        }
    }
    static var rememberRecentLookups: Bool {
        ...
        set {
            ...
            LogWriter.shared.write(.Debug, message: "Setting AppDefault: \(KEY_REMEMBER_RECENT_LOOKUPS) = \(newValue)")
        }
    }
    static var useLightTheme: Bool {
        ...
        set {
            ...
            LogWriter.shared.write(.Debug, message: "Setting AppDefault: \(KEY_USE_LIGHT_THEME) = \(newValue)")
        }
    }
    static var showTips: Bool {
        ...
        set {
            ...
            LogWriter.shared.write(.Debug, message: "Setting AppDefault: \(KEY_SHOW_TIPS) = \(newValue)")
        }
    }
    static var getHTTPHeaders: Bool {
        ...
        set {
            ...
            LogWriter.shared.write(.Debug, message: "Setting AppDefault: \(KEY_GET_HTTP_HEADERS) = \(newValue)")
        }
    }
    static var queryOCSP: Bool {
        ...
        set {
            ...
            LogWriter.shared.write(.Debug, message: "Setting AppDefault: \(KEY_QUERY_OCSP) = \(newValue)")
        }
    }
    static var checkCRL: Bool {
        ...
        set {
            ...
            LogWriter.shared.write(.Debug, message: "Setting AppDefault: \(KEY_CHECK_CRL) = \(newValue)")
        }
    }
    static var showFingerprintMD5: Bool {
        ...
        set {
            ...
            LogWriter.shared.write(.Debug, message: "Setting AppDefault: \(KEY_FINGEPRINT_MD5) = \(newValue)")
        }
    }
    static var showFingerprintSHA128: Bool {
        ...
        set {
            ...
            LogWriter.shared.write(.Debug, message: "Setting AppDefault: \(KEY_FINGEPRINT_SHA128) = \(newValue)")
        }
    }
    static var showFingerprintSHA256: Bool {
        ...
        set {
            ...
            LogWriter.shared.write(.Debug, message: "Setting AppDefault: \(KEY_FINGEPRINT_SHA256) = \(newValue)")
        }
    }
    static var showFingerprintSHA512: Bool {
        ...
        set {
            ...
            LogWriter.shared.write(.Debug, message: "Setting AppDefault: \(KEY_FINGEPRINT_SHA512) = \(newValue)")
        }
    }
    static var cryptoEngine: CryptoEngine {
        ...
        set {
            ...
            LogWriter.shared.write(.Debug, message: "Setting AppDefault: \(KEY_CRYPTO_ENGINE) = \(newValue)")
        }
    }
    static var ipVersion: IPVersion {
        ...
        set {
            ...
            LogWriter.shared.write(.Debug, message: "Setting AppDefault: \(KEY_IP_VERSION) = \(newValue)")
        }
    }
    static var preferredCiphers: String {
        ...
        set {
            ...
            LogWriter.shared.write(.Debug, message: "Setting AppDefault: \(KEY_PREFERRED_CIPHERS) = \(newValue)")
        }
    }
    static var contactNagDismissed: Bool {
        ...
        set {
            ...
            LogWriter.shared.write(.Debug, message: "Setting AppDefault: \(KEY_CONTACT_NAG_DISMISSED) = \(newValue)")
        }
    }
    static var advancedSettingsNagDismissed: Bool {
        ...
        set {
            ...
            LogWriter.shared.write(.Debug, message: "Setting AppDefault: \(KEY_ADVANCED_SETTINGS_NAG_DISMISSED) = \(newValue)")
        }
    }
    static var treatUnrecognizedAsTrusted: Bool {
        ...
        set {
            ...
            LogWriter.shared.write(.Debug, message: "Setting AppDefault: \(KEY_TREAT_UNRECOGNIZED_AS_TRUSTED) = \(newValue)")
        }
    }
    ...
    static var inspectTimeout: Int {
        ...
        set {
            ...
            LogWriter.shared.write(.Debug, message: "Setting AppDefault: \(KEY_INSPECT_TIMEOUT) = \(newValue)")
        }
    }
    ...
    static var verboseLogging: Bool {
        ...
        set {
            ...
            LogWriter.shared.write(.Debug, message: "Setting AppDefault: \(newValue) = \(newValue)")
        }
    }
    ...
    static func writeToFile() -> String? {
        ...
        do {
            ...
            LogWriter.shared.write(.Error, message: "Error writing settings file \(settingsFile.absoluteString): \(error.localizedDescription)")
            return nil
        }
    }
}
